...
'''
class HornAnySeven(CrapsStrategy):
    '''
    ...
    def craps(self, roll: int):
        ...
        if roll == 7:
            self.win(self.base_bet * 4 - (self.base_bet * 4))
        if roll in [11, 3]:
            self.win(self.base_bet * 15 - (self.base_bet * 5))
        if roll in [2, 12]:
            self.win(self.base_bet * 30 - (self.base_bet * 5))
    ...
    def point_made(self, roll: int):
        ...
        self.lost += 1
        self.end_balance -= (self.base_bet * 5)
